...
public class Bridge extends CuboidToggleMechanic {
    ...
    public List<String> getDefaultBlocks() {
        ...
        materials.add("minecraft:tuff");
        materials.add("minecraft:polished_tuff");
        materials.add("minecraft:tuff_bricks");
        materials.add("minecraft:chiseled_tuff");
        materials.add("minecraft:chiseled_tuff_bricks");
        materials.add("minecraft:white_concrete");
        materials.add("minecraft:orange_concrete");
        materials.add("minecraft:magenta_concrete");
        materials.add("minecraft:light_blue_concrete");
        materials.add("minecraft:yellow_concrete");
        materials.add("minecraft:lime_concrete");
        materials.add("minecraft:pink_concrete");
        materials.add("minecraft:gray_concrete");
        materials.add("minecraft:light_gray_concrete");
        materials.add("minecraft:cyan_concrete");
        materials.add("minecraft:purple_concrete");
        materials.add("minecraft:blue_concrete");
        materials.add("minecraft:brown_concrete");
        materials.add("minecraft:green_concrete");
        materials.add("minecraft:red_concrete");
        materials.add("minecraft:black_concrete");
        materials.add("minecraft:ice");
        materials.add("minecraft:packed_ice");
        materials.add("minecraft:blue_ice");
        materials.add("minecraft:frosted_ice");
        materials.add("minecraft:quartz_block");
        materials.add("minecraft:chiseled_quartz_block");
        materials.add("minecraft:quartz_pillar");
        materials.add("minecraft:smooth_quartz");
        materials.add("minecraft:quartz_bricks");
        materials.add("minecraft:copper_block");
        materials.add("minecraft:exposed_copper");
        materials.add("minecraft:weathered_copper");
        materials.add("minecraft:oxidized_copper");
        materials.add("minecraft:waxed_copper_block");
        materials.add("minecraft:waxed_exposed_copper");
        materials.add("minecraft:waxed_weathered_copper");
        materials.add("minecraft:waxed_oxidized_copper");
        return materials;
    }
